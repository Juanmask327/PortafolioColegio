...
// Mock products for accessories - Precios en COP
const accessoriesProducts = [
  {
    id: '13',
    name: 'Mochila Rosa Pastel',
    price: 149900,
    category: 'Mochilas',
    color: 'Rosa',
    image: '/images/mochila-rosa.jpg',
    rating: 4.5,
  },
  {
    id: '14',
    name: 'Cinturón Negro Elegante',
    price: 119900,
    category: 'Cinturones',
    color: 'Negro',
    image: '/images/cinturon-negro.jpg',
    rating: 4.6,
  },
  {
    id: '15',
    name: 'Bufanda Azul Suave',
    price: 99900,
    category: 'Bufandas',
    color: 'Azul',
    image: '/images/bufanda-azul.jpg',
    rating: 4.4,
  },
  {
    id: '16',
    ...
    category: 'Accesorios',
    color: 'Negro',
    image: '/images/gafas-retro.jpg',
    rating: 4.8,
  },
  {
    id: '17',
    name: 'Bolso Amarillo Vibrante',
    price: 199900,
    category: 'Bolsos',
    color: 'Amarillo',
    image: '/images/bolso-amarillo.jpg',
    rating: 4.7,
  },
  {
    id: '18',
    name: 'Reloj Minimalista Blanco',
    price: 379900,
    category: 'Relojes',
    color: 'Blanco',
    image: '/images/reloj-blanco.jpg',
    rating: 4.9,
  },
]
...
export default function AccessoriesPage() {
  ...
  const filteredProducts = useMemo(() => {
    let results = accessoriesProducts
      ...
      <section className="bg-gradient-to-r from-primary/20 via-secondary/20 to-accent/20 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground">
            Complementos perfectos para completar tu look
          </p>
        </div>
      </section>
